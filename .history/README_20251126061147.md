...
**Logs:** Siehe `tmp/dev-start.log` für alle Prozesse.

**E2E-Test:** Läuft automatisch im Watch-Modus (Playwright, siehe `e2e/course-access.spec.ts`).

**Maildev:** E-Mails werden an http://localhost:1080 zugestellt (Testumgebung).
