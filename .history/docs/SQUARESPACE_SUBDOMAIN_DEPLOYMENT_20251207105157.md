...
```
prostarmarketing.de (Squarespace)
    ↓
    Integration via Subdomain
    ↓
kurse.prostarmarketing.de (Hosting: Azure/Railway/Render)
    ↓
...
PORT=3000
NODE_ENV=production
SITE_URL=https://kurse.prostarmarketing.de
OAUTH_SERVER_URL=https://kurse.prostarmarketing.de
...
1. Klicke "Custom Domain"
2. Gib ein: `kurse.prostarmarketing.de`
3. Railway zeigt dir CNAME-Eintrag an:

```
CNAME: kurse → your-app-xyz.up.railway.app
```

#### 3.3 Squarespace DNS konfigurieren

**In Squarespace:**

1. Gehe zu **Settings** → **Domains** → **DNS Settings**
2. Klicke auf deine Domain `prostarmarketing.de`
3. Scrolle zu **DNS Settings** → **Advanced DNS Settings**
4. Klicke **Add Record**
...
Type: CNAME
Host: kurse
Points to: your-app-xyz.up.railway.app
TTL: 3600 (1 hour)
```

5. Speichern und warten (5-60 Minuten für DNS-Propagierung)

#### 3.4 SSL-Zertifikat aktivieren

Railway aktiviert automatisch Let's Encrypt SSL nach DNS-Propagierung:

1. Railway Dashboard → "Settings" → "Domains"
2. Warte bis "SSL Certificate" → "Active" anzeigt (kann 10-30 Minuten dauern)
3. Teste: `https://kurse.prostarmarketing.de`

### Phase 4: Integration mit Squarespace
...
Falls du einen Teaser auf der Hauptseite zeigen willst:
...
<div style="margin: 60px auto; max-width: 1200px;">
  ...
  <iframe 
    src="https://kurse.prostarmarketing.de/preview" 
    style="
      width: 100%; 
      height: 600px; 
      border: none; 
