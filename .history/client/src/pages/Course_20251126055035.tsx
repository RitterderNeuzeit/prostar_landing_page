  ...
  useEffect(() => {
    ...
    const loadCourseAccess = async () => {
      try {
        ...
        console.log("📦 [Course] localStorage.userEmail:", userEmail);
        console.log("📦 [Course] All localStorage keys:", Object.keys(localStorage));
        ...
        if (userEmail && mounted) {
          ...
          console.log("📦 [Course] Looking for tier key:", `userTier_${userEmail}`, "Found:", tier);
          console.log("📦 [Course] accessKey:", accessKey);

          if (tier === "starter" || tier === "professional" || tier === "enterprise") {
            console.log("✅ [Course] Tier found, setting state");
            setUserTier(tier);
            setCourseData({
              userEmail,
            ...
            console.warn("⚠️ [Course] Tier not found or invalid:", tier);
          }
        } else {
          console.warn("⚠️ [Course] No userEmail in localStorage");
        }
