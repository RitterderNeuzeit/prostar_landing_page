...
2. [Kurzübersicht](#1-kurzübersicht)
3. [Projekt-Struktur](#2-projekt-struktur)
4. [Essenzielle Befehle](#3-essenzielle-befehle)
5. [Kritische Regeln](#4-kritische-regeln)
6. [Copy-Paste Beispiele](#5-copy-paste-beispiele)
7. [Debugging & Testing](#6-debugging--testing)
8. [PR/Commit-Prozess](#7-prcommit-prozess)
9. [VS Code Automatisierung](#8-vs-code-automatisierung)
10. [Schnell-Referenzen](#9-schnell-referenzen)
11. [Weitere Informationen](#10-weitere-informationen)
...
**Achtung:** Stripe-Webhook-Middleware ist KRITISCH geordnet → Siehe [4.1 Stripe-Webhook](#41-stripe-webhook-middleware-reihenfolge).
