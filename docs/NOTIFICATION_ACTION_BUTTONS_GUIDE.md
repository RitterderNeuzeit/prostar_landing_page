...
const handlePurchaseSuccess = () => {
  ...
  addNotification({
    ...
    message:
      'Sie haben den "Von Zero zum KI-Profi" Kurs gekauft. Ihr Zugang ist sofort aktiv.',
    duration: 10000,
    actions: [
      {
        label: "Zum Kurs",
...
const handleEmailSignup = () => {
  ...
  addNotification({
    ...
    title: "Willkommen! 👋",
    message:
      "Bestätigen Sie Ihre E-Mail-Adresse, um Zugang zu exklusiven Inhalten zu erhalten.",
...
const handleLimitReached = () => {
  ...
  addNotification({
    ...
    message:
      "Sie haben Ihr kostenloses Limit erreicht. Upgraden Sie für unbegrenzten Zugriff.",
    actions: [
      {
