    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="section-padding">
        <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              {courseModules.map((module) => (
                <div key={module.number} className="card">
                  <div className="text-4xl font-bold text-accent mb-3">{module.number}</div>
          ...
          {/* Course Features */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold mb-8">Was ist im Kurs enthalten?</h2>
          ...
          <div className="card bg-card/50 border-2 border-accent/20 max-w-2xl mx-auto text-center py-12">
            ...
            <h3 className="text-2xl font-bold mb-4">30-Tage Geld-zurück Garantie</h3>
            <p className="text-muted-foreground">
              Wenn Sie nicht zu 100% zufrieden sind, erhalten Sie Ihr Geld zurück. Keine Fragen gestellt.
            </p>
          </div>
        </div>
      </main>
