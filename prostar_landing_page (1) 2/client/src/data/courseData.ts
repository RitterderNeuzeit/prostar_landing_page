...
export const courseModules: CourseModule[] = [
  {
    ...
    description: 'Verstehen Sie die Grundlagen von KI und warum gutes Prompting entscheidend ist.',
  ...
  },
  {
    ...
    description: 'Lernen Sie, KI wie einen Mitarbeiter zu führen - mit klaren Rollen und Kontext.',
  ...
  },
  {
    id: 3,
    title: 'KAAB-Formel',
    description: 'Die bewährte Formel für perfekte KI-Prompts: Kontext, Aufgabe, Anforderungen, Beispiel.',
  ...
  },
  {
    ...
    description: 'Meistern Sie die Kunst des Rollen-Prompting für präzisere KI-Ausgaben.',
  ...
  },
  {
    ...
    description: 'Verwenden Sie Chain-of-Thought Prompting für komplexe Problemlösungen.',
  ...
  },
  {
    ...
    description: 'Transformieren Sie KI-Chatbots in intelligente Agenten für Automation.',
  ...
  },
  {
    ...
    description: 'Schnelle Referenzen und Best Practices für tägliche KI-Nutzung.',
  ...
  },
  {
    ...
    description: 'Umfangreiche Vorlagen, Checklisten und Prompt-Vorlagen zum Downloaden.',
...
export function getModulesByTier(tier: 'starter' | 'professional' | 'enterprise'): CourseModule[] {
...
export function canAccessModule(moduleId: number, userTier: 'starter' | 'professional' | 'enterprise' | null): boolean {
