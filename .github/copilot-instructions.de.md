...
- **Tasks vorhanden:** `Start Project (start.sh)`, `Start Dev Server`, `Start Dev Server + Open`, `Open Live Preview (External)`, `Automation Assisten`.
- **Skripte:** `scripts/start.sh`, `scripts/start-dev-and-open.sh`, `scripts/open-dev-url.sh`, `scripts/assistant_automate.sh`, `scripts/assistant_automate.js`.
...
- **Ausführen:** VS Code Task `Automation Assisten` oder `node ./scripts/assistant_automate.js`.
