...
## 4. Kritische Regeln (KRITISCH)

### 4.1 Stripe-Webhook Middleware-Reihenfolge
...
## 8. VS Code Automatisierung

### 8.1 Verfügbare Tasks
...
### 8.2 VS Code Live Preview nutzen
...
### 8.3 Automation Assisten verwenden
...
- Struktur-Audit-Protokoll: \`.github/STRUCTURE_AUDIT_PROTOCOL.md\`
- Sprachrichtlinien: \`.github/LANGUAGE_POLICY.md\`
...
| --------- | ---------- | ------------------------------------------------------------------------------ |
| **1.1.0** | 19.11.2025 | ISO-Nummerierung, Executive Summary, ToC, Versionsverlauf, universelles Format |
| **1.0.0** | 19.11.2025 | Initial release (nach Dokumentations-Konsolidierung)                           |

---

**Zuletzt aktualisiert:** 2025-11-19 | **Sprache:** Deutsch | **Zielgruppe:** Entwickler & AI-Agenten  
**Format:** ISO-ähnliche Nummerierung (universell, wartbar, maschinenlesbar)
