#!/usr/bin/env node
/*
 Automation assisten (Node) - interactive automation for developer tasks
 - Prompts for a semicolon-separated list of shell commands
 - Waits up to TIMEOUT seconds (env or default 10) for input; falls back to defaults
 - Executes commands in sequence, starts long-running `dev` commands detached
 - Logs checkpoints to tmp_debug/assistant_checkpoints.md (YAML-like)
