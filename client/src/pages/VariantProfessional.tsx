...
export default function VariantProfessional() {
  ...
  const modules = [
    ...
    },
    {
      ...
      description:
        "Konvertieren Sie Social-Media-Aktivität in messbare Geschäftsergebnisse.",
  ...
  const faqs = [
    {
      ...
      answer:
        "Der Kurs ist für Unternehmer, Manager und Marketing-Profis konzipiert. Grundlegende Social-Media-Kenntnisse sind hilfreich, aber nicht erforderlich.",
    },
    {
      question: "Wie wird der Kurs aktualisiert?",
      answer:
        "Wir aktualisieren den Kurs monatlich mit neuen Strategien und Plattform-Updates. Alle Updates sind für Kursteilnehmer kostenlos.",
    },
    {
      question: "Gibt es ein Abschluss-Zertifikat?",
      answer:
        "Ja, nach Abschluss aller Module erhalten Sie ein professionelles Zertifikat für LinkedIn und Ihr Portfolio.",
    },
    {
      question: "Welche Plattformen werden abgedeckt?",
      answer:
        "LinkedIn, Instagram, Facebook, TikTok und YouTube mit spezifischen B2B- und B2C-Strategien.",
    },
    {
      question: "Kann ich den Kurs für mein Team nutzen?",
      answer:
        "Ja, Gruppen- und Unternehmenslizenzen sind verfügbar. Bitte kontaktieren Sie uns für Volumenrabatte.",
    },
    {
      question: "Wie ist der Support strukturiert?",
      answer:
        "Sie haben Zugriff auf ein exklusives Forum, monatliche Live-Q&A-Sessions und E-Mail-Support.",
    },
  ];
  ...
  return (
    <div>
      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-lg text-gray-600 mb-8 leading-relaxed">
            Professionelle Strategien für nachhaltiges Wachstum. Lernen Sie, wie
            führende Unternehmen Social Media nutzen, um ihre Geschäftsziele zu
            erreichen.
          </p>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Ohne kohärente Strategie führt Social Media zu
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Viele Unternehmen wissen nicht, ob ihre
                      Social-Media-Investitionen ROI bringen.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Die Plattformen entwickeln sich schnell, und es ist
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Ein bewährtes System, das alle Aspekte Ihrer
                      Social-Media-Präsenz abdeckt.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Lernen Sie, Ihre Metriken zu verstehen und Ihre Kampagnen
                      zu optimieren.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Monatliche Updates mit neuen Strategien und
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              Strukturiert vom Anfänger zum Experten. Jedes Modul baut auf dem
              vorherigen auf.
            </p>
          </div>
          ...
          <div className="space-y-4">
            {modules.map((module, index) => (
              <div
                key={module.id}
                className="border border-gray-200 rounded-lg p-6 hover:border-[#6B8E5F] transition-colors"
              >
                <div className="flex items-start gap-6">
                  <div className="w-16 h-16 bg-[#6B8E5F]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                    <span className="text-2xl font-bold text-[#6B8E5F]">
                      0{index + 1}
                    </span>
                  </div>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="text-center">
              <div className="text-4xl font-bold text-[#6B8E5F] mb-2">
                +250%
              </div>
              <p className="text-gray-600">
                Durchschnittliches Engagement-Wachstum
              </p>
            </div>
            <div className="text-center">
      ...
      {/* Testimonials (central component) */}
      ...
      <section className="py-20 md:py-32 bg-[#6B8E5F] text-white">
        <div className="container max-w-2xl">
          ...
          <p className="text-center text-white/90 text-lg mb-8">
            Erhalten Sie sofort Zugriff auf alle Module und beginnen Sie, Ihre
            Social-Media-Strategie zu transformieren.
          </p>
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full bg-white text-[#6B8E5F] hover:bg-gray-100 font-semibold"
            >
              Jetzt Kurs buchen
            </Button>
          </form>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-gray-400">
                Professionelle Social-Media-Strategien für nachhaltiges
                Geschäftswachstum.
              </p>
            </div>
