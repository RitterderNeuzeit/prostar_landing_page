...
export default function Home() {
  ...
  const [paymentModal, setPaymentModal] = useState<{ isOpen: boolean; tier?: 'starter' | 'professional' | 'enterprise'; price?: number }>({ isOpen: false });
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="sticky top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-border">
        <div className="container flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#modules" className="text-sm hover:text-accent transition-colors">Module</a>
            <a href="#results" className="text-sm hover:text-accent transition-colors">Ergebnisse</a>
            <a href="#pricing" className="text-sm hover:text-accent transition-colors">Preise</a>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="card">
              ...
              <h3 className="text-xl font-semibold mb-2">Keine klare Strategie</h3>
              <p className="text-muted-foreground">Ohne Strategie führt Social Media zu Zeitverschwendung und keinen messbaren Ergebnissen.</p>
            </div>
            ...
            <div className="card">
              ...
              <h3 className="text-xl font-semibold mb-2">Niedriges Engagement</h3>
              <p className="text-muted-foreground">Ihre Inhalte erreichen nicht die richtige Zielgruppe und generieren wenig Interaktion.</p>
            </div>
            ...
            <div className="card">
              ...
              <p className="text-muted-foreground">Social Media bringt keine echten Geschäftsergebnisse oder Verkäufe.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card border-l-4 border-accent">
              ...
              <p className="text-muted-foreground">Schritt-für-Schritt Anleitung zur Entwicklung Ihrer einzigartigen Social-Media-Strategie.</p>
            </div>
            
            <div className="card border-l-4 border-accent">
              <h3 className="text-xl font-semibold mb-2">✓ Hohe Engagement</h3>
              <p className="text-muted-foreground">Bewährte Taktiken zur Steigerung des Engagements und zum Aufbau einer loyalen Community.</p>
            </div>
            
            <div className="card border-l-4 border-accent">
              <h3 className="text-xl font-semibold mb-2">✓ Messbare Ergebnisse</h3>
              <p className="text-muted-foreground">Lernen Sie, Ihre Metriken zu verstehen und Ihre Kampagnen zu optimieren.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="modules" className="section-padding">
        <div className="container">
          <h2 className="text-4xl font-bold text-center mb-4">Was Sie lernen werden</h2>
          <p className="text-center text-muted-foreground text-lg mb-12 max-w-2xl mx-auto">
      ...
      <section id="results" className="section-padding bg-card">
        <div className="container">
          <h2 className="text-4xl font-bold text-center mb-4">Format & Ergebnisse</h2>
          <p className="text-center text-muted-foreground text-lg mb-12 max-w-2xl mx-auto">
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="card">
              ...
              <CheckoutButton tier="starter" className="w-full btn-secondary">Jetzt buchen</CheckoutButton>
            </div>
            ...
            <div className="card border-2 border-accent relative">
              ...
              <p className="text-muted-foreground mb-6">Für wachsende Unternehmen</p>
              <div className="mb-6">
              ...
              <CheckoutButton tier="professional" className="w-full btn-primary">Jetzt buchen</CheckoutButton>
            </div>
            
            <div className="card">
              <h3 className="text-2xl font-bold mb-2">Enterprise</h3>
              <p className="text-muted-foreground mb-6">Für Teams & Agenturen</p>
              <div className="mb-6">
              ...
              <CheckoutButton tier="enterprise" className="w-full btn-secondary">Jetzt buchen</CheckoutButton>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-gradient-to-r from-accent/10 to-accent/5">
        <div className="container max-w-2xl">
          <h2 className="text-4xl font-bold text-center mb-4">Kostenlose Mini-Lektion</h2>
      ...
      <section id="faq" className="section-padding">
        <div className="container max-w-3xl">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className="card cursor-pointer" onClick={() => setActiveTab(activeTab === index ? -1 : index)}>
                <div className="flex items-center justify-between">
                  <h3 className="font-semibold text-lg">{faq.question}</h3>
                  <ChevronDown className={`w-5 h-5 text-accent transition-transform ${activeTab === index ? 'rotate-180' : ''}`} />
                </div>
                {activeTab === index && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Wir helfen Unternehmern, ihre Social-Media-Präsenz aufzubauen und zu monetarisieren.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><a href="#" className="hover:text-accent transition-colors">Kurse</a></li>
                <li><a href="#" className="hover:text-accent transition-colors">Coaching</a></li>
