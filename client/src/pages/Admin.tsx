    ...
    >
      ...
      <div className="container py-8">
        ...
        <div className="flex gap-2 mb-4">
          ...
          <button onClick={save} className="btn-secondary" disabled={loading}>
            Save
          </button>
        ...
        <div className="mb-6">
          ...
          <input
            ...
            onChange={e =>
              setData({
                ...data,
                brand: { ...(data?.brand || {}), title: e.target.value },
              })
            }
            placeholder="Title"
          />
          <input
            ...
            onChange={e =>
              setData({
                ...data,
                brand: { ...(data?.brand || {}), headline: e.target.value },
              })
            }
          ...
          <input
            className="w-full p-2 rounded border"
            value={data?.brand?.subheadline || ""}
            onChange={e =>
              setData({
                ...data,
                brand: { ...(data?.brand || {}), subheadline: e.target.value },
              })
            }
        ...
        <div className="mb-6">
          ...
          <pre
            className="w-full p-3 rounded border bg-card text-sm overflow-auto"
            style={{ maxHeight: 320 }}
          >
