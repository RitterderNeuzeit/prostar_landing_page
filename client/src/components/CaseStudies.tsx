      ...
      <div className="container">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className={`text-lg ${classes.subheading}`}>
            Echte Unternehmer, echte Ergebnisse. Sehen Sie, wie andere
            Unternehmen ihre Social-Media-Präsenz transformiert haben.
          </p>
        </div>
          ...
          {caseStudies.map(study => (
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3 className={`text-xl font-bold ${classes.heading}`}>
                    {study.company}
                  </h3>
              ...
              <div className="flex items-center gap-4 mb-4 pb-4 border-b border-gray-200/30">
                <div className="flex-1">
                  <p className={`text-sm font-semibold ${classes.heading}`}>
                    {study.founder}
                  </p>
                  <p className={`text-xs ${classes.subheading}`}>
                    {study.duration} Transformation
                  </p>
                </div>
              ...
              {/* Challenge */}
              <div className="mb-4">
                <h4 className={`text-sm font-semibold ${classes.accent} mb-2`}>
                  Die Herausforderung
                </h4>
                <p className={`text-sm ${classes.subheading}`}>
                  {study.challenge}
              ...
              <div className="grid grid-cols-3 gap-3 mb-4">
                <div
                  className={`text-center p-3 rounded ${variant === "professional" ? "bg-gray-100" : variant === "artisanal" ? "bg-[#C85A3A]/10" : "bg-accent/10"}`}
                >
                  <p className={`text-lg font-bold ${classes.metric}`}>
              ...
              {expandedId === study.id && (
                <div className="mt-6 pt-6 border-t border-gray-200/30 animate-slide-up">
                  <h4
                    className={`text-sm font-semibold ${classes.accent} mb-2`}
                  >
                    Die Lösung
                  </h4>
                  <p className={`text-sm ${classes.subheading} mb-4`}>
                    {study.solution}
                  </p>
                  ...
                  <div className="space-y-3 mb-4">
                    <div>
                      ...
                      <p className={`text-xs ${classes.subheading}`}>
                        {study.results.metric1.description}
                      </p>
                    </div>
                    <div>
                      <p className={`text-sm font-semibold ${classes.heading}`}>
                      ...
                      <p className={`text-xs ${classes.subheading}`}>
                        {study.results.metric2.description}
                      </p>
                    </div>
                    <div>
                      <p className={`text-sm font-semibold ${classes.heading}`}>
                      ...
                      <p className={`text-xs ${classes.subheading}`}>
                        {study.results.metric3.description}
                      </p>
                    </div>
                  </div>
                  ...
                  <p className={`text-sm italic ${classes.subheading}`}>
                    "{study.testimonial}"
                  </p>
                </div>
              )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 pt-16 border-t border-gray-200/30">
          <div className="text-center">
            <div className={`text-4xl font-bold ${classes.metric} mb-2`}>
              500+
            </div>
